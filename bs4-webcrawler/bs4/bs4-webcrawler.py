    ...
    try:
        ...
        for a_tag in soup.find_all('a', href=True):
            ...
            if 'url=' in href:
                ...
                if not (link.endswith('.jpg') or link.endswith('.png') or link.endswith('.gif') or link.endswith('.mp4') or 'vimeo.com' in link or 'instagram.com' in link or 'imgur.com' in link or 'download' in link or 'attachment' in link or 'google.com' in link or 'youtube.com' in link) and ('http' in link or 'https' in link):
